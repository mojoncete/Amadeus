...
;	18/1/24
;
;	Tabla de velocidades según Nivel de dificultad.
;
Velocidades_Nivel1 db 1,1,1,1 						; Vel_left, Vel_right, Vel_up, Vel_downa. (1, 2, 4 u 8 px).
Velocidades_Nivel2 db 1,1,1,2
